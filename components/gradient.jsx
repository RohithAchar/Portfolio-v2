<div className="relative">
  <div className="absolute -inset-2 rounded-lg bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-rose-600 via-neutral-600 to-gray-600 opacity-50 blur-2xl"></div>
